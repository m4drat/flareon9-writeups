...
def main():
    ...
    encrypted_ahoy = base64.b64decode(
        b"\x79\x00\x64\x00\x4e\x00\x38\x00\x42\x00\x58\x00\x71\x00\x31\x00\x36\x00\x52\x00\x45\x00\x3d\x00".decode(
            "utf-16"
        )
    )
    ...
    encrypted_sce = base64.b64decode(
        b"\x56\x00\x59\x00\x42\x00\x55\x00\x70\x00\x5a\x00\x64\x00\x47\x00".decode(
            "utf-16"
        )
    )
